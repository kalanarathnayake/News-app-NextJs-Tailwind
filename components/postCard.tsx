...
const PostCard = () => {
    return (
        ...
        <div className="relative mb-6 overflow-hidden shadow-md pb-80">
            <Image
            className="absolute object-cover object-top w-full rounded-t shadow-lg h-80 lg:roun"
            src={recentnewsimage}
            alt={""}
            />
        </div>
        ...
        reiciendis eaque quae cum quis dolorum voluptate necessitatibus sunt
        minus ducimus! Possimus, similique voluptatibus nulla natus beatae
        fugiat repudiandae modi dignissimos?
        </p>
